...
export const metadata: Metadata = {
  ...
  title: {
    default: "JLPT 日本語能力試験 対策学習アプリ | 860問の無料練習問題",
    template: "%s | JLPT学習",
  },
  description: "JLPT N1〜N5の練習問題を860問無料で学習。語彙・文法・読解・聴解の全カテゴリ対応。カテゴリ別の苦手分析機能付き。",
  ...
  openGraph: {
    ...
    description: "N1〜N5の練習問題を860問無料で学習。語彙・文法・読解・聴解の全カテゴリ対応。",
  ...
  twitter: {
    ...
    title: "JLPT 日本語能力試験 対策学習アプリ",
    description: "N1〜N5の練習問題を860問無料で学習",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    url: "https://jlpt.howlrs.net",
    description: "JLPT N1〜N5の練習問題を860問無料で学習",
    inLanguage: "ja",
    potentialAction: {
      "@type": "SearchAction",
  ...
  const courseJsonLd = {
    ...
    description: "JLPT N1〜N5の練習問題を860問収録。語彙・文法・読解・聴解の全カテゴリ対応。",
    provider: {
      "@type": "Organization",
      name: "JLPT学習",
      url: "https://jlpt.howlrs.net",
